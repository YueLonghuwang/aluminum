package com.rengu.project.aluminum.specification;

import com.rengu.project.aluminum.exception.SpecificationException;
...
import static com.rengu.project.aluminum.specification.Filter.*;
...
public class WhereSpecification implements Specification<Object> {
    ...
    private Predicate doGetPredicate(Filter filter, Path<Object> root, CriteriaBuilder cb) throws SpecificationException {
        ...
        try {
            ...
            throw new SpecificationException("Unable to filter by: " + filter + ", value type:" + value.getClass() + ", operator: " + operator + ", entity type:" + path.getJavaType() + ", message: " + e.getMessage(), e);
        }
    }
